...
public class MultiplePath {
    ...
    /**
     * Findet alle minimalen Pfade von start zu ziel.
     * @param start ID der Startstation
     * @param ziel ID der Zielstation
     * @return Liste aller minimalen Pfade (jeder Pfad ist Liste von IDs)
     */
        ...
        while (!pq.isEmpty()) {
            ...
            for (WeightedGraph.Edge edge : graph.getNeighbors(current)) {
                ...
                if (newDist < dist.get(neighbor)) {
                    ...
                    // Alternativer Vorgänger für Multiple Pfade
    ...
    /**
     * Gibt alle Stationen aus, die ab start mehrere minimale Pfade haben,
     * inklusive aller minimalen Pfade zu dieser Station und deren Gesamtreisezeit.
     */
